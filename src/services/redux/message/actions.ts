...
export const { sendMessage, sendMessageSuccess, sendMessageFail } =
  createAsyncAction("sendMessage", "SEND_MESSAGE");

export const { receiveMessageSuccess } = createAsyncAction(
  "receiveMessageSuccess",
  "RECEIVE_MESSAGE_SUCCESS"
);

export const { sentFileSuccess } = createAsyncAction(
  "sentFileSuccess",
  "SENT_FILE_SUCCESS"
);

export const { deactiveConversation } = createAsyncAction(
  "deactiveConversation",
  "DEACTIVE_CONVERSATION"
);
...
export const { loadMessages, loadMessagesSuccess, loadMessagesFail } =
