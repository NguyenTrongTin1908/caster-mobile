...
const ModelProfile = ({ handleLogout, route, current }: Props): React.ReactElement => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        <Image
          source={performer?.cover ? { uri: performer?.cover } : require('../../../assets/bg.jpg')}
        ...
        <View style={styles.avContainer}>
          <View style={styles.avBlueRound}>
            <Image
              source={performer?.avatar ? { uri: performer?.avatar } : require('../../../assets/avatar-default.png')}
              alt={'avatar'}
              size={100}
              borderRadius={80}
              resizeMode="cover"
