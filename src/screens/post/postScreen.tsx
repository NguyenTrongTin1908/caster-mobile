...
const PostScreen = () => {
  ...
  const postVideoButton = () => {
    return (
      <TouchableOpacity activeOpacity={0.9} onPress={() => handlePostVideo} style={styles.postVideoButtonStyle}>
        <Text style={{}}>Post Video</Text>
      </TouchableOpacity>
    );
  };
  ...
  const saveToGalleryInfo = () => {
    return (
      <View style={styles.saveToGalleryInfoWrapStyle}>
        <Text style={{}}>Save to Gallery</Text>
        <Switch
          value={saveToGallery}
          onValueChange={val => {
  ...
  const selectCoverInfo = () => {
    ...
    return (
      <View>
        <Text style={{ marginHorizontal: Sizes.fixPadding }}>Select Cover</Text>
        <FlatList
